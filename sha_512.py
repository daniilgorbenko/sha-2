...
# первые 64 бита дробных частей квадратных корней первых восьми простых чисел
h0 = hex_to_bin(0x6a09e667f3bcc908)
h1 = hex_to_bin(0xbb67ae8584caa73b)
h2 = hex_to_bin(0x3c6ef372fe94f82b)
h3 = hex_to_bin(0xa54ff53a5f1d36f1)
h4 = hex_to_bin(0x510e527fade682d1)
h5 = hex_to_bin(0x9b05688c2b3e6c1f)
h6 = hex_to_bin(0x1f83d9abfb41bd6b)
h7 = hex_to_bin(0x5be0cd19137e2179)
# таблица констант
